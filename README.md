...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ujo4tv8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ujo4tv8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Design-Fab/container-ujo4tv8.git
cd container-ujo4tv8
```
...
```
docker attach container-ujo4tv8
```
